...
INSERT INTO `admin3`.`sys_asset` (`id`, `name`, `code`, `pid`, `pids`, `type`, `controller`, `view`, `icon_css`, `is_menu`, `sort`) VALUES ('5', '系统管理', 'sys', '0', '0', 'node', '', '', 'sf-cog', '1', '50');
...
INSERT INTO `admin3`.`sys_asset` (`id`, `name`, `code`, `pid`, `pids`, `type`, `controller`, `view`, `icon_css`, `is_menu`, `sort`) VALUES ('14', '网址导航', 'guide', '0', '0', 'menu', 'home/guide', 'guide/list', 'sf-paper-plane', '1', '10');
INSERT INTO `admin3`.`sys_asset` (`id`, `name`, `code`, `pid`, `pids`, `type`, `controller`, `view`, `icon_css`, `is_menu`, `sort`) VALUES ('15', '网址导航-子页面', 'guideSort', '0', '0', 'menu', 'home/guide.1', 'guide/sort', '', '0', '10');
